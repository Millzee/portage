...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/portage/portage-2.2_rc23.ebuild,v 1.1 2009/01/19 00:22:41 zmedico Exp $
...
# Build fix
SRC_URI="${SRC_URI} http://dev.gentoo.org/~zmedico/tmp/duplicate_cpv_builddir.patch"
# RDEPEND fix
SRC_URI="${SRC_URI} http://dev.gentoo.org/~zmedico/tmp/rdepend_problem.patch"

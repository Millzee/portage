####################################################################
# $Header: /var/cvsroot/gentoo-x86/profiles/package.mask,v 1.9523 2009/02/26 22:46:46 zzam Exp $
#
...
# Lots of ebuild cleanup, adds new, experimental VDPAU support
# Also adds internal dvdnav support.
# Just needs some general testing before foisting upon the world.
>=media-video/mplayer-20090226.28734

# Rémi Cardona <remi@gentoo.org> (26 Feb 2009)
# Upstream says it's a bugfix release but the ChangeLog indicates otherwise.
# p.masked until it has been sufficiently tested (by us or others)
